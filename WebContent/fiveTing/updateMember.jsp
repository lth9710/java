...
id:<input readonly="readonly" type="text" value="${dtoMember.id }" name="id"><br/>
이름:${dtoMember.name } <input type="hidden" value="${dtoMember.name }" name="name"><br/>
비밀번호:<input type="password" border="1" name="pwd" value="${dtoMember.pwd }"><br/>
직업:<input type="text" border="1" name="job" value="${dtoMember.job }"><br/>
주소:<input type="text" border="1" name="address" value="${dtoMember.address }"><br/>
키:<input type="text" border="1" name="height" value="${dtoMember.height }"><br/>
체형:<input type="text" border="1" name="body" value="${dtoMember.body }"><br/>
연락처:<input type="text" border="1" name="tel" value="${dtoMember.tel }"><br/>
소개:<input type="text" border="1" name="content" value="${dtoMember.content }"><br/>
사진명:<input type="file" border="1" name="picture" value="${dtoMember.picture }"><br/>
<img src="${imagePathMember }/${dtoMember.picture }"><br/>
<input type="button" value="수정하기" onclick="sendId();"/>
<input type="button" value="취소하기" onclick="javascript:location.href='profile.do';"/>
