...
<script type="text/javascript" src="<%=cp%>/fiveTing/js/mail.js"></script>
</head>
<body onload="document.all.mail_subject.focus();">
<jsp:include page="/fiveTing/header.jsp" flush="false"/>
<br/>

<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr height="40">
		<td width="50%" style="font-size: 40pt; text-align: left; color: #000000">
		Q&A Email
		</td>
	</tr>
</table>
...
<table border="0" width="600" border="0" cellspacing="0" cellpadding="3" align="center" style="font-size: 10pt;">
	<tr>
		<td width="140" height="30" style="padding-left: 20px; font-size: 13pt;">
		제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
		<td width="460" style="padding-left: 10px;">
		<input type="text" name="mail_subject" size="35" maxlength="20" class="boxTF"/>
		</td>
	</tr>
	<tr height="25">
		<td></td>
	...
	<tr>
		...
		이&nbsp;메&nbsp;일 </td>
		<td width="460" style="padding-left: 10px;">
		<input type="text" name="mail_senderEmail" size="35" maxlength="20" class="boxTF"/>
		</td>
	</tr>
	<tr height="25">
		<td></td>
	...
	<tr>
		...
		이&nbsp;&nbsp;&nbsp;&nbsp;름</td>
		<td width="460" style="padding-left: 10px;">
		<input type="text" name="mail_senderName" size="35" maxlength="20" class="boxTF"/>
		</td>
	</tr>
	<tr height="25">
		<td></td>
	...
	<tr>
		...
		내&nbsp;&nbsp;&nbsp;&nbsp;용 </td>
		<td width="460" style="padding-left: 10px;">
		<textarea rows="12" cols="62" name="mail_content" class="boxTA"></textarea>
		</td>
	</tr>
</table>
...
<table width="600" border="0" cellpadding="3" cellspacing="0" align="center">
	<tr align="center">
		<td width="300" align="right">
			<input type="image" src="${imagePath }/button/btn_send.png" onclick="mailSend();"/>
		</td>
		<td width="250">
			<input type="image" src="${imagePath }/button/btn_reset.png" onclick=""/>
		</td>
	</tr>
</table>
</form>
