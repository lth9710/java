...
<%
	...
	String senderName = (String)request.getAttribute("mail_senderName");
	String senderEmail = (String)request.getAttribute("mail_senderEmail");
	String receiverEmail = (String)request.getAttribute("mail_receiverEmail");
	String subject = (String)request.getAttribute("mail_subject");
	String content = (String)request.getAttribute("mail_content");
	
	String host = "localhost"; //"192.168,16.30"
	...
	//javax.mail.Session은 Java Mail API를 사용하는 출발점이 되는 클래스
		...
		try{
			...
			response.sendRedirect("qnaEmailFinish.do");
