...
<script type="text/javascript">
	...
	function sendIt() {
	    ...
	    f.action = "${pageContext.request.contextPath}/five/rawrite_ok.do";
	    f.submit();
	}
...
<jsp:include page="/fiveTing/header.jsp" flush="false"/>
	...
	<div class="content" align="center">
		...
		<form  method="post" name="myForm" enctype="multipart/form-data">
			<div class="fields">
				...
				<div class="field half">
					...
					<input type="text" name="name" value="${sessionScope.MemberInfo.name }" />
				</div>
				<!-- <div class="field">
		...
		<input type="hidden" border="1" name="num" value="0"><br />
		<input type="hidden" border="1" name="pageNum" value="${pageNum}"><br />
