...
function idCheck(){
	...
	if(f.userId.value==temp){alert("중복된 아이디가 존재합니다.");}
	}
	alert("사용가능한 아이디입니다.");
...
<tr>
	...
	<td colspan="4">&nbsp;&nbsp; <input type="password" align="middle" name="userPwd"> <a href="" style="font-size: 5pt;">비밀번호 도움말</a></td>
</tr>

<tr>
	<td width="155" height="40"><img src="../html1/image/2naver7.PNG" width="100%"></td>
	<td colspan="4">&nbsp;&nbsp; <input type="password" align="middle" name="userPwd2">
</td>
