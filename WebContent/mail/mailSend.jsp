...
<link rel="stylesheet" href="<%=cp%>/mail/data/style.css"
type="text/css"/>
...
<tr><td colspan="2" height="3" bgcolor="#dbdbdb" align="left"></td></tr>
...
<tr>
	<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px;">보내는 사람 E-Mail </td>
	<td width="460" style="padding-left: 10px;">
...
<tr>
	<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px;">받는사람 이름 </td>
	<td width="460" style="padding-left: 10px;">
	<input type="text" name="receiverName" size="35" maxlength="20" class="boxTF"/>
	</td>
</tr>
...
<tr>
	<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px;">받는사람 E-Mail </td>
	<td width="460" style="padding-left: 10px;">
...
<tr>
	<td width="140" height="30" bgcolor="#eeeeee"
	 style="padding-left: 20px;">첨부파일</td>
	 
	 <td width="460" style="padding-left: 10px;">
	 <input type="file" name="fileName" maxlength="100"
	 size="48" class="boxTF"/>
	 </td>
</tr>	
